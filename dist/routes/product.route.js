...
router.put("/:id", (0, auth_1.default)(), (0, validate_1.default)(product_validate_1.default.updateProductSchema), product_controller_1.default.updateProduct);
router.delete("/:id", (0, auth_1.default)(), (0, validate_1.default)(product_validate_1.default.deleteProductSchema), product_controller_1.default.deleteProduct);
